...
savedir = '/rds/projects/p/piettaaa-exo-mapping/stellar_activity_retrievals/data/emission/'
results_root = '/rds/projects/p/piettaaa-exo-mapping/code/plastar/examples/emission/results/'
